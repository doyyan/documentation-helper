...
tavily_map = TavilyMap(max_depth=3, max_breadth=20, max_pages=500)
...
async def main():
    ...
    # Get Tavily crawl results (already Document objects)
    ...
    for doc in all_docs:
        log_info(
            f"TavilyCrawl: Successfully crawled {doc['url']} from documentation site"
        )
        documents.append(
            Document(
